...
$sql = "SELECT * FROM datab WHERE status = 'tersedia'";
    $result = mysqli_query($server, $sql);
    $jumlahA = mysqli_num_rows($result);
    $sqli = "SELECT * FROM datab WHERE status = 'dipinjam'";
...
if (isset($_POST['pinjam'])) {
    ...
    if (in_array($kodeBarang, $_SESSION['peminjaman'])) {
        ...
        $sql = "UPDATE datab SET status = 'dipinjam' WHERE no_barang = '$kodeBarang'";
    ...
    <div class="row justify-content-end">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4" style="flex: 0 0 25%; max-width: 25%;">
          <div class="card" onclick="openModal('modal')" style="padding-left: -10px;">
            <div class="image-container <?php echo ($barang['status'] == 'dipinjam') ? 'dipinjam' : ''; ?>">
              <img src="img/vector.png" style="position: absolute; left: 34.67%; right: 34.17%; top: 25.15%; bottom: 45.61%;">
              <div class="status">
                <p>no laptop: <span style="padding-left: 1.5rem;"><?php echo $barang['nama_barang']; ?></span></p>
      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <hr>
            <img src="img/vector.png" style="width: 60px; height: auto; margin-top: 30px;"> 
            <div class="p">
          <p>Laptop lenovo</p>
